...
template<> ::Net::Vector3D* Arena::CreateMaybeMessage<::Net::Vector3D>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace Net {
	...
	class Vector3D :
		public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Net.Vector3D) */ {
	public:
		Vector3D();
		virtual ~Vector3D();
	...
	public:
		...
		// @@protoc_insertion_point(class_scope:Net.Vector3D)
	private:
		class _Internal;
...
// float x = 1;
	...
	inline float Vector3D::x() const {
		// @@protoc_insertion_point(field_get:Net.Vector3D.x)
		return x_;
	}
	inline void Vector3D::set_x(float value) {

		x_ = value;
		// @@protoc_insertion_point(field_set:Net.Vector3D.x)
	}
	...
	inline float Vector3D::y() const {
		// @@protoc_insertion_point(field_get:Net.Vector3D.y)
		return y_;
	}
	inline void Vector3D::set_y(float value) {

		y_ = value;
		// @@protoc_insertion_point(field_set:Net.Vector3D.y)
	}
	...
	inline float Vector3D::z() const {
		// @@protoc_insertion_point(field_get:Net.Vector3D.z)
		return z_;
	}
	inline void Vector3D::set_z(float value) {

		z_ = value;
		// @@protoc_insertion_point(field_set:Net.Vector3D.z)
	}
	...
	inline const ::Net::Vector3D& LastWorld::position() const {
	...
	inline ::Net::Vector3D* LastWorld::release_position() {
	...
	inline ::Net::Vector3D* LastWorld::mutable_position() {
	...
	inline void LastWorld::set_allocated_position(::Net::Vector3D* position) {
